 ...
 */
public class CeaserCipherFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.ceaser_fragment, container, false);
        ...
        final CaeserCipher ac = new CaeserCipher();
