 ...
 */
public class AffineCeaserFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.affineceaser_fragment, container, false);
        ...
        final AffineCaeser ac = new AffineCaeser();
